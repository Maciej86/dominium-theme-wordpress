<?php
  ...
  $up_menu_instagram = get_theme_mod("up_menu_facebook", $defaults["up_menu"]["instagram"]);
  $up_menu_tiktok = get_theme_mod("up_menu_facebook", $defaults["up_menu"]["tiktok"]);
        ...
        <div class="footer__box">
          ...
          <div class="footer__box__social_media">
            ...
            <?php if ( !empty( $up_menu_facebook ) ) : ?>
              <a href="<?php echo esc_html( $up_menu_facebook ); ?>">
            ...
            <?php if ( !empty( $up_menu_instagram ) ) : ?>
              <a href="<?php echo esc_html( $up_menu_instagram ); ?>">
                <svg fill="currentColor" height="20px" width="20px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-271 273 256 256" xml:space="preserve">
            ...
            <?php if ( !empty( $up_menu_tiktok ) ) : ?>
              <a href="<?php echo esc_html( $up_menu_tiktok ); ?>">
                <svg width="20px" height="20px" viewBox="-3 0 164 164" fill="none" xmlns="http://www.w3.org/2000/svg">
